...
// An Elixir node release reads the same bootstrap as one JSON line on stdin and
// speaks the telemetry channel on the same descriptors. It keeps its state under
// `<t3Home>/elixir`.
